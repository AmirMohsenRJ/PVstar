<?php
define('API_KEY','https://github.com/PHPBotCreator/PvResanSaz.git');
//----######------
...
//===========
$inch = file_get_contents("https://api.telegram.org/bot".API_KEY."/getChatMember?chat_id=@Eroricm&user_id=".$from_id);
    ...
    var_dump(
        makereq('editMessageText',[
            ...
            'reply_markup'=>json_encode([
                'inline_keyboard'=>[
                    [
                        ['text'=>"به کانال ما بپیوندید - Pease join to my channel",'url'=>"https://telegram.me/eroricm"]
                    ]
                ]
            ])
        ])
    ...
    var_dump(
        makereq('editMessageText',[
            ...
            'reply_markup'=>json_encode([
                'inline_keyboard'=>[
                    [
                        ['text'=>"به کانال ما بپیوندید - Pleas join to my channel",'url'=>"https://telegram.me/eroricm"]
                    ]
                ]
            ])
        ])
